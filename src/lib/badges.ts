...
export const BADGE_REGISTRY: Record<string, BadgeDefinition> = {
    'green_flag': { id: 'green_flag', name: 'Green Flag', description: 'Added your first vehicle to the Digital Garage', tier: 'bronze', icon: 'Flag' },
    ...
    'ai_mechanic': { id: 'ai_mechanic', name: 'AI Mechanic', description: 'Used Veloce Copilot to automatically extract a receipt', tier: 'platinum', icon: 'Bot' },
};
