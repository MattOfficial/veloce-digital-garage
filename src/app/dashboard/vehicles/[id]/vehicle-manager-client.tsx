...
export function VehicleManagerClient({
  ...
  const { fetchVehicles, selectedVehicleId, setSelectedVehicleId } =
    useVehicleStore();
  ...
  // Calculate Vitals
  const totalFuelCost = vehicle.fuel_logs.reduce(
    (sum, log) => sum + log.total_cost,
    0,
  );
  const totalMaintenanceCost = vehicle.maintenance_logs.reduce(
  ...
  const serviceIntervalStatus = serviceInterval
    ? getServiceReminderStatus(serviceInterval, latestOdometer)
    : null;
  ...
  async function handleSaveServiceInterval(
    ...
    try {
      ...
      if (result.reminder) {
        const existing = vehicle.service_reminders.filter(
          (reminder) => reminder.id !== result.reminder.id,
        );
        setVehicle({
          ...vehicle,
          service_reminders: [result.reminder, ...existing],
        });
      }
      await fetchVehicles();
      router.refresh();
      ...
      const messageText =
        error instanceof Error
          ? error.message
          : "Failed to update service interval.";
    ...
    <MotionWrapper className="space-y-6 pb-20">
      ...
      <div className="relative -mt-6 -mx-4 md:-mx-8 px-4 md:px-8 pt-8 pb-16 bg-muted overflow-hidden flex flex-col justify-end min-h-[300px] border-b">
        ...
        <div className="relative z-10 space-y-4">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center text-sm font-semibold text-primary-foreground bg-primary/95 hover:bg-primary shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95 mb-4 px-5 py-2.5 rounded-full w-fit"
          >
          ...
          <div>
            <div className="flex items-center gap-3 text-primary text-sm font-bold tracking-wider uppercase mb-2">
              ...
              {vehicle.engine_type && (
                <div className="bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 px-3 py-1 rounded-full">
                  {vehicle.engine_type}
                </div>
              )}
            </div>
        ...
        <div className="md:col-span-2 space-y-6">
            ...
            <CardHeader className="flex flex-row items-start justify-between">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  if (nextEditingState) {
                    setCustomFields(
                      Object.entries(vehicle.custom_fields || {}).map(
                ...
                <form onSubmit={handleUpdateSpecs} className="space-y-6">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder={ui.vehicle.nicknamePlaceholder}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder={ui.vehicle.vinPlaceholder}
                        className="rounded-xl font-mono uppercase"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="license_plate">
                        {ui.vehicle.licensePlate}
                      </Label>
                      <Input
                        id="license_plate"
                        name="license_plate"
                        defaultValue={vehicle.license_plate || ""}
                        placeholder={ui.vehicle.licensePlatePlaceholder}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder={ui.vehicle.exteriorColorPlaceholder}
                        className="rounded-xl"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder={ui.vehicle.engineTypePlaceholder}
                        className="rounded-xl"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="transmission">
                        {ui.vehicle.transmission}
                      </Label>
                      <Input
                        id="transmission"
                        name="transmission"
                        defaultValue={vehicle.transmission || ""}
                        placeholder={ui.vehicle.transmissionPlaceholder}
                        className="rounded-xl"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="any"
                        defaultValue={
                          vehicle.current_odometer ?? latestOdometer
                        }
                  ...
                  <div className="space-y-4 pt-4 border-t border-border/50">
                    <div className="flex items-center justify-between">
                      <Label className="text-base font-semibold">
                        {ui.vehicle.customSpecifications}
                      </Label>
                      <Button
                        type="button"
                        variant="outline"
                  ...
                  <div className="flex justify-end pt-4">
                    ...
                    >
                      ...
                      {isSaving
                        ? ui.vehicle.savingSpecifications
                        : ui.vehicle.saveSpecifications}
                    </Button>
                  </div>
                </form>
              ) : (
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    <div className="space-y-1">
                      ...
                      <p className="font-medium text-foreground tracking-wide">
                        {vehicle.nickname || ui.vehicle.emptyValue}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="font-medium text-foreground uppercase tracking-wide">
                        {vehicle.vin || ui.vehicle.emptyValue}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="font-medium text-foreground uppercase tracking-wide">
                        {vehicle.license_plate || ui.vehicle.emptyValue}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                        {ui.vehicle.exteriorColor}
                      </p>
                      <p className="font-medium text-foreground">
                        {vehicle.color || ui.vehicle.emptyValue}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="font-medium text-foreground">
                        {vehicle.engine_type || ui.vehicle.emptyValue}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="font-medium text-foreground">
                        {vehicle.transmission || ui.vehicle.emptyValue}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                        {ui.vehicle.modelYear}
                      </p>
                      <p className="font-medium text-foreground">
                        {vehicle.year}
                      </p>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="font-medium text-foreground">
                        {latestOdometer.toLocaleString()} {profile.distanceUnit}
                      </p>
                    </div>
          ...
          <Card className="rounded-[2rem] shadow-sm border overflow-hidden">
            <CardHeader>
              ...
              <CardDescription>
                {ui.vehicle.serviceIntervalDescription}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSaveServiceInterval} className="space-y-5">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="recurring_months">
                      {ui.vehicle.serviceIntervalMonths}
                    </Label>
                    <Input
                      id="recurring_months"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="recurring_distance">
                      {ui.vehicle.serviceIntervalDistance(profile.distanceUnit)}
                    </Label>
                    <Input
                ...
                {serviceInterval && serviceIntervalStatus ? (
                  ...
                  <p className="text-sm text-muted-foreground">
                    {ui.vehicle.serviceIntervalEmpty}
                  </p>
                )}
                ...
                <div className="flex justify-end">
                  <Button
                    type="submit"
                    disabled={isSavingServiceInterval}
                    className="rounded-full px-6 shadow-md"
                  >
                    {isSavingServiceInterval
                      ? ui.common.actions.saving
                      : ui.vehicle.serviceIntervalSave}
                  </Button>
                </div>
              </form>
            </CardContent>
        ...
        <Card className="rounded-[2rem] shadow-sm border overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between pb-2 bg-muted/20 border-b">
            <div className="space-y-1">
              ...
              <CardDescription>
                {ui.vehicle.serviceHistoryDescription}
              </CardDescription>
            </div>
            ...
            {vehicle.maintenance_logs && vehicle.maintenance_logs.length > 0 ? (
                ...
                <Table>
                  <TableHeader className="bg-muted/10">
                    <TableRow className="border-b/50 hover:bg-transparent">
                      <TableHead className="w-[120px] font-semibold text-muted-foreground pl-6">
                        {ui.vehicle.columns.date}
                      </TableHead>
                      <TableHead className="font-semibold text-muted-foreground">
                        {ui.vehicle.columns.serviceType}
                      </TableHead>
                      <TableHead className="font-semibold text-muted-foreground">
                        {ui.vehicle.columns.odometer}
                      </TableHead>
                      <TableHead className="font-semibold text-muted-foreground w-1/3">
                        {ui.vehicle.columns.notes}
                      </TableHead>
                      <TableHead className="text-right font-semibold text-muted-foreground pr-6">
                        {ui.vehicle.columns.cost}
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {vehicle.maintenance_logs
                      .sort(
                        (a, b) =>
                      ...
                      .map((log) => (
                        ...
                        >
                          ...
                          <TableCell className="text-muted-foreground/80">
                            {log.odometer != null
                              ? `${log.odometer.toLocaleString()} ${profile.distanceUnit}`
              ...
              <div className="flex flex-col items-center justify-center p-12 text-center bg-muted/5 min-h-[250px]">
                ...
                <h3 className="text-lg font-semibold tracking-tight text-foreground/90">
                  {ui.vehicle.serviceHistoryEmptyTitle}
                </h3>
