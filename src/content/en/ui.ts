...
export const ui = {
    ...
    landing: {
        ...
        description: "Track fuel, log maintenance, and monitor your vehicle statistics with unparalleled elegance.",
    ...
    uploads: {
        ...
        documents: {
            ...
            vaultLockedDescription: "Please add your Gemini API key in Profile Settings to use invoice tracking.",
            ...
            uploadDescription: "Drag and drop an image or PDF of your receipt, or click to browse. Max 5MB.",
        },
    },
    copilot: {
        messages: {
            ...
            failedConnection: "An error occurred connecting to the AI. Please try again later.",
    ...
    dashboard: {
        ...
        noVehiclesFoundDescription: "Please add a vehicle to your garage to view the dashboard and analytics.",
        goToProfile: "Go to Profile",
        overviewTitle: "Overview",
        overviewDescription: (vehicleLabel: string) => `Tracking analytics and insights for your ${vehicleLabel}.`,
        ...
        previousThirtyDaysComparison: (trend: number) => `${trend > 0 ? "↑" : trend < 0 ? "↓" : ""} ${Math.abs(trend).toFixed(1)}% vs previous 30 days`,
        ...
        basedOnAvailableOdometerLogs: "Based on the odometer logs currently available",
        ...
        noRecentActivity: "No recent activity found. Log your first fill-up or service!",
        quickActionsTitle: "Quick Actions",
        quickActionsDescription: "Add new records to your vehicle without leaving the dashboard.",
    ...
    fuel: {
        ...
        modal: {
            ...
            description: (vehicleLabel: string) => `Enter details for your ${vehicleLabel}.`,
            tabs: {
                fuel: "Fuel",
                charge: "Charge",
            },
            ...
            editDescription: "Update the details for this fill-up. Efficiency will be recalculated automatically.",
        ...
        deleteDialog: {
            ...
            description: (logDate: string) => `You are about to permanently delete the fill-up entry from ${logDate}. This action cannot be undone.`,
            warningTitle: "Permanent deletion warning",
            warningBody: "Deleting this entry will also affect the efficiency calculations for subsequent fill-ups.",
    ...
    insights: {
        ...
        pageTitle: "Insights",
        pageDescription: (vehicleLabel: string) => `Running costs, distance trends, and cadence insights for your ${vehicleLabel}.`,
        pageDescriptionShort: (vehicleLabel: string) => `See how your ${vehicleLabel} costs and drives over time.`,
        tabs: {
        ...
        distanceSectionDescription: "Recent distance rollups and monthly driving history from odometer logs",
        distanceLastThirtyDays: "Distance Last 30 Days",
        distanceLastTwelveMonths: "Distance Last 12 Months",
        monthlyDistanceHistoryTitle: "Monthly Distance History",
        monthlyDistanceHistoryDescription: "Trailing 12-month view of distance covered",
        distanceInsufficientDataTitle: "Not Enough Distance Data",
        distanceInsufficientDataDescription: "Add odometer-bearing fuel or charge logs to unlock distance history.",
        basedOnAvailableOdometerLogs: "Based on the odometer logs currently available",
    ...
    maintenance: {
        ...
        pageDescription: (vehicleLabel: string) => `Predictive vitals and expense tracking for your ${vehicleLabel}.`,
        noVehicleSelectedTitle: "No Vehicle Selected",
        noVehicleSelectedDescription: "Select a vehicle to view maintenance schedules.",
        tabs: {
            overview: "Overview",
            invoices: "Service",
            trackers: "Trackers",
        ...
        currentOdometer: "Current Odometer",
        currentOdometerDescription: "Used to calculate service intervals and due reminders",
        maintenanceCostPerDistance: (unit: string) => `Maintenance Cost per ${unit.toUpperCase()}`,
        ...
        healthMonitorDescription: (odometer: string, unit: string) => `Estimated lifespan of critical components based on your odometer (${odometer}${unit}).`,
        healthHealthy: "Healthy",
        noMaintenanceLoggedTitle: "No maintenance logged",
        noMaintenanceLoggedDescription: "Log your first service to unlock spending breakdowns and historical analytics.",
        spendByCategory: "Spend by Category",
        maintenanceTimeline: "Maintenance Timeline",
        maintenanceTimelineDescription: "Visualize the frequency and cost of shop visits.",
        serviceLogTitle: "Service Log",
        serviceLogDescription: "Detailed history of all documented repairs and maintenance.",
        noServiceRecordsTitle: "No service records found",
        noServiceRecordsDescription: "When you log your first service, it will appear here.",
        columns: {
            date: "Date",
        ...
        trackersDescription: "Keep track of other vital health data like washer fluid, coolants, or accessories.",
        addMaintenance: {
            ...
            description: {
                create: "This record will be permanently attached to this vehicle's history.",
        ...
        reminders: {
            ...
            description: "Track a component lifespan. We will alert you when service is due based on time or mileage.",
            ...
            descriptionList: "Uses the manufacturer interval saved in Vehicle Details.",
            emptyTitle: "Service interval not set",
            emptyDescription: "Set the manufacturer service interval in Vehicle Details to start due notifications.",
            ...
            everyMonths: (months: number) => `Every ${months} month${months === 1 ? "" : "s"}`,
            everyDistance: (distance: string, unit: string) => `Every ${distance} ${unit}`,
            delete: "Delete reminder",
        },
        ocr: {
            title: "AI Receipt Analysis",
            description: "Review the extracted data before saving it to your vehicle's history.",
    ...
    trackers: {
        ...
        createTrackerDescription: "Build a custom widget to track events on your vehicles.",
        iconLabels: {
            Sparkles: "Sparkles",
            Droplets: "Droplets",
        ...
        widgetDescription: (name: string) => `Track timeline events for ${name.toLowerCase()}.`,
        logEvent: "Log Event",
        ...
        deleteTrackerConfirm: (name: string) => `Are you sure you want to permanently delete the "${name}" tracker and all its historical logs? This cannot be undone.`,
        noEntriesYet: "No entries yet",
        noEntriesDescription: "You have not created any custom trackers yet. Add one to start monitoring specific parts or services for your vehicle.",
        startTrackingDescription: (name: string) => `Start tracking events for your ${name.toLowerCase()} here.`,
        ...
        tyre: {
            ...
            updateTiresDescription: "Register new tires or update tread depth for your wheels.",
            noTireInfo: "No tire information recorded. Add your tires to track their lifespan and receive alerts.",
            addTires: "Add Tires",
            addTiresDescription: "Enter the details of the tires currently on the vehicle.",
            close: "Close",
            noTireForPosition: "No tire logged for this position.",
            interactiveMapTitle: "Interactive Tire Map",
            interactiveMapDescription: "Tap on any wheel on the diagram to see its specific details, age, and tread depth.",
    ...
    vehicle: {
        ...
        odometer: "Odometer",
        currentOdometer: "Current Odometer",
        currentOdometerDescription: "Update this when you want reminders to reflect your latest reading immediately.",
        currentOdometerPlaceholder: "e.g. 46250",
        currentOdometerUpdated: "Current odometer updated.",
        serviceIntervalTitle: "Service Interval",
        serviceIntervalDescription: "Save the manufacturer interval, such as 12 months or 10,000 km, whichever comes first.",
        ...
        serviceIntervalNeedsServiceLog: "The next due date will start after you log a scheduled service.",
        fuelTotal: "Fuel Total",
        maintenanceTotal: "Maint. Total",
        specsTitle: "Specifications & Details",
        specsDescription: "Manage your vehicle's identifying information and attributes.",
        cancel: "Cancel",
        ...
        notesPlaceholder: "Insurance policy numbers, radio codes, tire pressure specs, or any other reminders...",
        ...
        noCustomSpecifications: "No custom specifications added. Click the button above to add one.",
        ...
        serviceHistoryDescription: "A complete log of maintenance performed on this vehicle.",
        serviceHistoryEmptyTitle: "No Service History",
        serviceHistoryEmptyDescription: "This vehicle does not have any maintenance records yet. Keep track of oil changes, tire rotations, and repairs to monitor its health.",
        columns: {
            date: "Date",
    ...
    profile: {
        ...
        distanceAnalyticsDescription: "Recent and lifetime distance totals across every vehicle in your garage.",
        distanceLastThirtyDays: "Distance Last 30 Days",
        distanceLastTwelveMonths: "Distance Last 12 Months",
        lifetimeDistance: "Lifetime Distance",
        distanceUnavailable: "Unavailable",
        distanceUnavailableDescription: "Add odometer-bearing fuel or charge logs to unlock this metric.",
        distanceFullCoverageDescription: "Across every vehicle in your garage.",
        distancePartialCoverage: (contributingVehicles: number, totalVehicles: number) => `Based on available odometer logs from ${contributingVehicles} of ${totalVehicles} vehicles.`,
        ...
        displayNameDescription: "This is the name that will be displayed in the application sidebar.",
        preferredCurrency: "Preferred Currency",
        currencyPlaceholder: "Select a currency",
        currencyDescription: "This currency symbol will be used across all your tracking and insights.",
        distanceUnit: "Distance Unit",
        distanceUnitPlaceholder: "Select distance unit",
        distanceUnitDescription: "Will affect speed, volumes (Liters vs Gallons) and economy rates.",
        distanceOptions: {
        ...
        clearStorageConfirm: "This will clear your local and session storage (session persistence). You might need to refresh. Continue?",
        ...
        bringYourOwnKeys: "Bring your own keys to enable AI features. They will be encrypted with AES-256 before storage.",
        ...
        addVehicleDescription: "Enter the details of your vehicle to start tracking it.",
        ...
        emptyGarageDescription: "Add a vehicle to start tracking your fuel and maintenance.",
        active: "Active",
