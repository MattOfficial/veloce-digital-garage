...
Veloce is a Next.js vehicle ownership tracker for logging fuel, maintenance, custom vehicle health data, and AI-assisted receipt intake.
...
- Running-cost insights at `/dashboard/insights`
- Profile, BYOK provider settings, badges, and garage management at `/dashboard/profile`
...
5. Validate production readiness with `npm run build`.
