...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-6ICQM557.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-YMVSR5C4.js"), act = await getAct();
...
//# sourceMappingURL=chunk-2AGM34QE.js.map
